...
// int nbr_paths1 = KShorthestPathComputer::ComputeKShorthestNodeDisjointPaths(*this, DEFAULT_MAX_TRAJ, MAX_PATH_LENGTH, labeled_objects);
// printf("nbr paths %04d",nbr_paths1);
